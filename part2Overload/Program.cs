...
namespace Assignment9ex2Operatoroverloading
{
    public class Log
    {
        ...
        public static Log operator ++ (Log Activity)
        {
            Activity++;
            return Activity;
        }
        ...
        // overloaded operator + and operator -
        public static Log operator + (Log Hours)
        {
        ...
        // overloaded operator > and operator <
        public static bool operator > (Log totalFun, Log totalWork)
        {
            bool entry = false;
            if (totalFun > totalWork)
                entry = true;
            return entry;
        }
    ...
    {
        static void Main(string[] args, int entry)
        {
